...
public class ArtistView {
    ...
    private void printMenu() {
        ...
        System.out.println("8. View All Archived Artist");
    ...
    private void searchArtist() {
        ...
        if (choice == 1) {
            ...
            List<Artist> results = artistController.handleSearchArtist(keyword);
    ...
    private void viewAllArchivedArtists() {
        ...
        List<Artist> archived = artistController.handleViewAllArchivedArtists();
        displayArtists(archived);
    }
}